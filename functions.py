...
#     if app.action == "Hover":
#         app.acton = "Slide"
#     app.mainSpriteImages = [f'{BASE_SPRITE_URL}{app.action}__00{i}.png' for i in range(10)]
#     app.mainSpriteImages = [PILImage.open(i) for i in app.mainSpriteImages]
#     app.mainSpriteImages = [CMUImage(i) for i in app.mainSpriteImages]
#     print(app.mainSpriteImages)
