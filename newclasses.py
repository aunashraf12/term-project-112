...
#         if app.pendulum.swinging == False and app.pendulum.released == False:
...
#                 drawRect(pole[0] - app.pendulumOffsetX, pole[1], pole[2], self.height)
#             elif app.released == True:
#                 drawRect(pole[0] - app.pendulumOffsetX, pole[1], pole[2], self.height)
#             else:
...
# class SwingingPendulum:
#     def __init__(self, origin, length, bobRadius, gravity):
#         app.releaseTimer = 0
#         self.origin = origin  # Pivot point (tuple)
#         self.length = length  # Length of the pendulum
#         self.bobRadius = bobRadius  # Radius of the pendulum bob
#         self.gravity = gravity  # Gravity (m/s²)
...
#         self.released = False  # Whether the pendulum has been released

#         # Bob position after release
#         self.bobX = None
#         self.bobY = None
#         self.bobDX = 0  # Horizontal velocity after release
#         self.bobDY = 0  # Vertical velocity after release

#     def startSwinging(self):
#         """Starts the pendulum swing."""
...
#             self.bobX = self.origin[0] + self.length * math.sin(self.angle)
#             self.bobY = self.origin[1] + self.length * math.cos(self.angle)
...
#             self.angularVelocity *= 0.9999995
...
#             self.bobX += self.bobDX * self.timeStep
#             self.bobY += self.bobDY * self.timeStep

#     def set(self):
#         """Draws the pendulum."""
#         # Draw the pendulum pivot
#         # drawCircle(self.origin[0], self.origin[1], 5, fill="black")

#         if not self.released:
#             # Calculate pendulum bob position
#             bobX = self.origin[0] + self.length * math.sin(self.angle)
#             bobY = self.origin[1] + self.length * math.cos(self.angle)
#             app.pendulumOffsetX = bobX - app.mainChar.pos[1]
#             app.mainChar.pos[1] = bobY

#             # Draw the pendulum rod
#             # drawLine(self.origin[0], self.origin[1], bobX, bobY, fill="black", lineWidth=2)

#             # Draw the pendulum bob
#             # drawCircle(bobX, bobY, self.bobRadius, fill="red")

#         else:
#             pass
#             # Draw the released bob
#             # if self.bobX is not None and self.bobY is not None:
#                 # drawCircle(self.bobX, self.bobY, self.bobRadius, fill="red")
